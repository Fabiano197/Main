							...
							<div class="responsive-video"><iframe src="https://www.youtube.com/embed/Qg1qZq5yjps" frameborder="0" allowfullscreen></iframe></div>
				
            <div id="ab" class="panel panel-primary post">
                <div class="post-heading">
                    <div class="pull-left meta">
                        <h3 class="panel-title">
                            <a href="#"><b>Kapitel 1</b></a>
                        </h3>
                    </div>
                </div> 
                <div class="post-description"> 
                    <p>Das Licht muss sein. Ohne Licht gibt es kein Bild. Also sei schlau und schalte das Licht ein!</p>
                </div>
            </div>
        </div>
		...
		<div class="row">
  <div class="col-sm-4">
			<a href="/content/pdf/Algen.pdf" class="thumbnail thumb" download>		
      <img class="thumb" src="content/pics/missing.png"/></a></div>
	 <div class="col-sm-4"> <a href="/content/pdf/Algen.pdf" class="thumbnail thumb" download>		
      <img class="thumb" src="content/pics/missing.png"/></a></div>
	 <div class="col-sm-4"> <a href="/content/pdf/Algen.pdf" class="thumbnail thumb" download>		
      <img class="thumb" src="content/pics/missing.png"/></a></div>
	  </div>
...
<!-- <div class="col-sm-8 ask">
    <div class="input-group">
  	...
  	<?php
		...
		if(empty($_POST['kommentar']) && !empty($_POST['titel'])){
			...
			if($berechtigung > 0){
				echo '<form action="Kapitel.php?kap=Licht" method="POST" id="usrform">
    ...
    <div class="input-group">
      <span class="input-group-btn">
        <input type="submit" value="senden" name="submitbutton" class="btn btn-primary">Senden</input>
      </span>
    </div>
  </div>
				</form>';
			...
			<nav>
  <ul class="pager">
    <li><a href="kapitel.php?kap=Belichtung_Teil2"><button class="btn btn-primary">Zurück</button></a></li>
    <li><a href="kapitel.php?kap=Ton"><button class="btn btn-primary">Weiter</button></a></li>
  </ul>
</nav>
